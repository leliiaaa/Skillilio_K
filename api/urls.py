...
urlpatterns = [
    ...
    path('order/<int:order_id>/ai-start/', views.ai_interview_start, name='ai_interview_start'),
    ...
    path('order/<int:order_id>/assign/<int:freelancer_id>/', views.assign_freelancer, name='assign_freelancer'),
